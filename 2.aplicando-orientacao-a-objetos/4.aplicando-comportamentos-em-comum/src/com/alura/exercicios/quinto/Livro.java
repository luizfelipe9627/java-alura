...
public class Livro implements Calculavel {
  private String nome; // Criado um atributo do tipo String chamado nome, que armazena o nome do livro.
  private double preco; // Criado um atributo do tipo double chamado preco, que armazena o preço do livro.
  private double desconto; // Criado um atributo do tipo double chamado desconto, que armazena o desconto do livro.
