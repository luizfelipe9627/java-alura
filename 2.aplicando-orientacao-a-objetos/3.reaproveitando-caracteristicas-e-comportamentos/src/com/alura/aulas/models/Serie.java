...
public class Serie extends Titulo {
  ...
  //* > Override
  /*
    O @Override é uma anotação que indica que o método está sobrescrevendo um método da classe pai, ou seja, ele está substituindo o método da classe pai pelo método da classe filha.
  */
