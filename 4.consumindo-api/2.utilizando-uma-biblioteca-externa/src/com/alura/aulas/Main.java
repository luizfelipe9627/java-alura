...
import com.alura.aulas.model.TituloOMDB;
...
public class Main {
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    Titulo meuTitulo = gson
    // O método fromJson() é usado para converter o JSON em um objeto Java, recebe como parâmetro a resposta da requisição HTTP e a classe que representa o objeto Java, que no caso é a classe Titulo.
    .fromJson(json, Titulo.class);

    System.out.println(meuTitulo); // Está sendo impresso o nome do filme.
    ...
    Titulo meuTitulo2 = new Titulo(meuTituloOMDB); // Está sendo criado um novo objeto Titulo chamado meuTitulo2, que recebe como parâmetro o objeto meuTituloOMDB.

    System.out.println("Meu título convertido: " + meuTitulo2); // Está sendo impresso o nome do filme, ano de lançamento e duração do filme.
  }
}
